# Generated from: ECC_Pipeline_Combined.ipynb
# Converted at: 2026-08-19T02:27:40.109Z
...
# Keep these as zero so any leftover references don't crash. PSH constraints
# are removed from the variant classes below.
PSH_S_THRESHOLD = 0.0
PSH_E_THRESHOLD = 0.0
...
class V3_PhysicsOnly(Problem):
    """NSGA-II + binder cap; no PSH (replaced by fiber-design check), no uncertainty propagation."""
    def __init__(self):
        super().__init__(n_var=9, n_obj=3, n_ieq_constr=1,
                         xl=LB_v2, xu=UB_v2, elementwise=False)
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        out['G'] = (np.array(binder) - BINDER_CAP_99).reshape(-1, 1)
